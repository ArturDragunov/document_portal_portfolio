...
class CustomLogger:
    ...
    def get_logger(self, name=__file__):
        ...
        """
        # you do it separately because for console and file you need different logging
        ...
        # Avoid duplicate handlers if logger is reused -> The check prevents log spam from duplicate handlers.
